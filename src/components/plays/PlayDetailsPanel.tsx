...
export function PlayDetailsPanel({
  ...
  return (
    <aside className="w-full border-t border-[#584237]/35 bg-[#1c1b1d]/95 p-4 backdrop-blur-xl xl:absolute xl:left-6 xl:top-6 xl:z-30 xl:w-[340px] xl:border xl:shadow-[0_22px_50px_rgba(0,0,0,0.45)]">
      <PlaySelector plays={plays} selectedPlayId={play.id} onSelect={onSelectPlay} />

      <div className="mt-5 border-t border-[#584237]/35 pt-5">
        ...
        <p className="mt-4 text-sm leading-6 text-[#ccc5c1]">{play.description}</p>
      </div>
      ...
      <div className="mt-5 border-t border-[#584237]/35 pt-5">
        ...
        <p className="mt-1 text-sm leading-6 text-[#ccc5c1]">{activeStep?.description}</p>
      </div>

      <ol className="mt-5 grid gap-2 border-t border-[#584237]/35 pt-5">
        {play.steps.map((step, index) => {
          ...
          return (
            ...
            >
              <span className="font-mono text-[11px] text-orange-300">0{index + 1}</span>
