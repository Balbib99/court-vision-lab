export function CourtLines() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {/* Shared hand-drawn-ink filter, referenced by id from MovementPath and TacticalAnnotation too. */}
      <defs>
        <filter id="ink-jitter" x="-30%" y="-30%" width="160%" height="160%">
      ...
      <g filter="url(#ink-jitter)">
        ...
        <circle cx="5.2" cy="28.125" r="0.9" fill="none" stroke="var(--court-line)" strokeOpacity="0.62" strokeWidth="0.32" />
        ...
        <circle cx="94.8" cy="28.125" r="0.9" fill="none" stroke="var(--court-line)" strokeOpacity="0.62" strokeWidth="0.32" />
